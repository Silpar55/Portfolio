  ...
  return (
    ...
    >
      <div className="text-center xl:basis-2/3">
        <h1 className="font-bold text-5xl md:text-6xl xl:text-7xl text-sky-400">
          {title}
        </h1>
      ...
      <div
        className={`flex flex-col xl:basis-1/3 ${
          imgUrl2 && "xl:basis-1/4"
        } sm:px-5`}
      >
        {imgUrl && (
          <Image
        ...
        {imgUrl2 && (
          <Image
            ...
            width={400}
            height={400}
            className={` w-auto h-32 md:h-44 xl:w-full xl:h-auto m-auto`}
          />
        )}
      </div>
    </section>
